...
--[[
ITEM_CLASS_NEED["Tissu"]=ITEM_CLASS_NEED["Тканевые"]
ITEM_CLASS_NEED["Cuir"]=ITEM_CLASS_NEED["Кожаные"]
ITEM_CLASS_NEED["Mailles"]=ITEM_CLASS_NEED["Кольчужные"]
ITEM_CLASS_NEED["Plaques"]=ITEM_CLASS_NEED["Латные"]
ITEM_CLASS_NEED['Divers']=ITEM_CLASS_NEED['Разное']
]]
local L = RAID_ROLL_HELPER.L
--SYSTEM
L["Самоцвет"]="Gemme"
L["Реликвия артефакта"]="Relique d’arme prodigieuse"
L["Доспехи"]="Armure"
L["Тканевые"]="Tissu"
L["Кожаные"]="Cuir"
L["Кольчужные"]="Mailles"
L["Латные"]="Plaques"
L["Разное"]="Divers"
L["Оружие"]="Armes"
L["спеки"] = {
