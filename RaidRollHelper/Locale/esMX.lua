...
--[[
ITEM_CLASS_NEED["Tela"]=ITEM_CLASS_NEED["Тканевые"]
ITEM_CLASS_NEED["Cuero"]=ITEM_CLASS_NEED["Кожаные"]
ITEM_CLASS_NEED["Malla"]=ITEM_CLASS_NEED["Кольчужные"]
ITEM_CLASS_NEED["Placas"]=ITEM_CLASS_NEED["Латные"]
ITEM_CLASS_NEED['Miscelánea']=ITEM_CLASS_NEED['Разное']
]]
local L = RAID_ROLL_HELPER.L
--SYSTEM
L["Самоцвет"]="Gema"
L["Реликвия артефакта"]="Reliquia de artefacto"
L["Доспехи"]="Armadura"
L["Тканевые"]="Tela"
L["Кожаные"]="Cuero"
L["Кольчужные"]="Malla"
