...
--[[
ITEM_CLASS_NEED["Tecido"]=ITEM_CLASS_NEED["Тканевые"]
ITEM_CLASS_NEED["Couro"]=ITEM_CLASS_NEED["Кожаные"]
ITEM_CLASS_NEED["Malha"]=ITEM_CLASS_NEED["Кольчужные"]
ITEM_CLASS_NEED["Placas"]=ITEM_CLASS_NEED["Латные"]
ITEM_CLASS_NEED['Diversos']=ITEM_CLASS_NEED['Разное']
]]
local L = RAID_ROLL_HELPER.L
--SYSTEM
L["Самоцвет"]="Gema"
L["Реликвия артефакта"]="Relíquia de Artefato"
L["Доспехи"]="Armadura"
L["Тканевые"]="Tecido"
L["Кожаные"]="Couro"
L["Кольчужные"]="Malha"
