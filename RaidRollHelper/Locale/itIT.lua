...
--[[
ITEM_CLASS_NEED["Stoffa"]=ITEM_CLASS_NEED["Тканевые"]
ITEM_CLASS_NEED["Cuoio"]=ITEM_CLASS_NEED["Кожаные"]
ITEM_CLASS_NEED["Maglia"]=ITEM_CLASS_NEED["Кольчужные"]
ITEM_CLASS_NEED["Piastre"]=ITEM_CLASS_NEED["Латные"]
ITEM_CLASS_NEED['Varie']=ITEM_CLASS_NEED['Разное']
]]
