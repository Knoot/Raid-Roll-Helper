...
--[[
ITEM_CLASS_NEED["Stoff"]=ITEM_CLASS_NEED["Тканевые"]
ITEM_CLASS_NEED["Leder"]=ITEM_CLASS_NEED["Кожаные"]
ITEM_CLASS_NEED["Kette"]=ITEM_CLASS_NEED["Кольчужные"]
ITEM_CLASS_NEED["Platte"]=ITEM_CLASS_NEED["Латные"]
ITEM_CLASS_NEED['Verschiedenes']=ITEM_CLASS_NEED['Разное']
]]
local L = RAID_ROLL_HELPER.L
--SYSTEM
L["Самоцвет"]="Edelstein"
L["Реликвия артефакта"]="Artefaktrelikt"
L["Доспехи"]="Rüstung"
L["Тканевые"]="Stoff"
L["Кожаные"]="Leder"
L["Кольчужные"]="Kette"
L["Латные"]="Platte"
L["Разное"]="Verschiedenes"
L["Оружие"]="Waffen"
L["спеки"] = {
